...
1.  **Stage 1 (Day 1)**: A "Gentle" email created and send reminder to customer.
2.  **Stage 2 (Day 10)**: A "Firm" follow-up sent automatically.
3.  **Final Stage**: A "Manager Escalation" where leadership is notified to step in and goes and create the draft.
...
2.  **Sending Reminders**: When PayPilot's logic says "It's time for a reminder," it sends a signal to n8n. n8n then talks to your **Gmail** to create a draft or send the email directly.

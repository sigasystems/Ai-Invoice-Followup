            ...
            <CardHeader className="bg-neutral-50/50 border-b border-neutral-100 p-8">
               <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                     <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest leading-none mb-2">Due Date</p>
      ...
      <span className="font-bold">
        ...
        <div className="space-y-8">
           ...
           <Card className="rounded-3xl border-none shadow-xl bg-gradient-to-br from-indigo-600 to-primary text-white p-6 relative overflow-hidden">
              ...
              <h4 className="text-xs font-bold uppercase tracking-widest text-white/70 mb-4">AI Collection Forecast</h4>
